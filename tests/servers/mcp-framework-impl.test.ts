/**
 * Tests for mcp-framework server implementation
 * Tests auto-discovery pattern with MCPTool and MCPResource classes
 */

import { jest, describe, it, expect, beforeEach } from '@jest/globals';
import { sanitizeExpression, validateExpression } from '../../servers/mcp-framework-impl/src/utils/expression.js';

describe('mcp-framework Implementation', () => {
  describe('Expression Utilities', () => {
    describe('sanitizeExpression', () => {
      ...
      it('should reject expressions with dangerous patterns', () => {
        ...
        expect(() => sanitizeExpression('require')).toThrow('invalid characters');
      });
    ...
    describe('validateExpression', () => {
      ...
      it('should accept valid expressions', () => {
        ...
        expect(() => validateExpression('-2 + 5')).not.toThrow();
      });
    });
  });
  ...
  describe('MCPTool Pattern', () => {
    it('should have required tool properties', () => {
      ...
      expect(toolTemplate).toHaveProperty('name');
      expect(toolTemplate).toHaveProperty('description');
      expect(toolTemplate).toHaveProperty('schema');
    });

    it('should define execute method signature', async () => {
